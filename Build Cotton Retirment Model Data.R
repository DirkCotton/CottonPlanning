...
sigma50yr <-  c(.0336,.043,.0556,.0696,.0843,.0994,.1148,.1304,.1461,.162)
...
annualReturn [i] <- return50yr [equityAlloc[i] * 10]
sigma50yr [i] <- sigma50yr [equityAlloc[i] * 10]
...
write.csv(scenarios.df,"~/desktop/CottonScenarios.csv")
